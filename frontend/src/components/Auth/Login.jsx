      ...
      <div className="relative w-full max-w-md">
        ...
        <div className="relative bg-slate-900/90 backdrop-blur-xl rounded-2xl p-8 border border-slate-800/50 shadow-2xl">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-slate-400">Sign in to your SentimentAI account</p>
          </div>
          ...
          <div className="relative mb-6">
            ...
            <div className="relative flex justify-center text-sm">
              <span className="px-4 text-slate-400 bg-slate-900/90">Or continue with email</span>
            </div>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              ...
              <input
                ...
                required
                className="w-full px-4 py-3 bg-slate-800/50 border border-slate-700 rounded-xl text-white placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-cyan-500 focus:border-transparent transition-all duration-200"
            ...
            <div className="flex items-center justify-between">
              <label className="flex items-center">
                <input type="checkbox" className="rounded border-slate-700 text-cyan-500 focus:ring-cyan-500 focus:ring-offset-slate-900" />
